  ...
  [6261],
  {
    3096: function (t, e, n) {
      ...
      function y(t, e, n) {
        ...
        function w(t) {
          return (c = t), (s = setTimeout(_, e)), f ? b(t) : u;
        }
        function O(t) {
          var n = t - l;
        ...
        function S(t) {
          return (s = void 0), y && r ? b(t) : ((r = i = void 0), u);
        }
        function P() {
          var t = v(),
            n = O(t);
          if (((r = arguments), (i = this), (l = t), n)) {
            ...
            if (d) return (s = setTimeout(_, e)), b(l);
          }
          return void 0 === s && (s = setTimeout(_, e)), u;
        }
        return (
          (e = g(e) || 0),
          m(n) &&
            ((f = !!n.leading),
            (a = (d = "maxWait" in n) ? p(g(n.maxWait) || 0, e) : a),
            (y = "trailing" in n ? !!n.trailing : y)),
          (P.cancel = function () {
            void 0 !== s && clearTimeout(s), (c = 0), (r = l = i = s = void 0);
          }),
          (P.flush = function () {
            return void 0 === s ? u : S(v());
          }),
          P
        );
      }
      ...
      t.exports = function (t, e, n) {
        ...
        return (
          ...
          y(t, e, { leading: r, maxWait: e, trailing: i })
        );
      };
    },
    8477: function (t, e, n) {
      ...
      var s = function (t) {
        ...
        h = function (t, e, n, o) {
          if (
            ...
            (e.data.start = null),
            (e.data.cancel = !1),
            (e.data.startPosition = e.horizontal ? c(e) : f(e)),
                ...
                if (!l.default.isMounted() || l.default.isInitialized()) {
                  ...
                  if (s && (O !== a || !1 === t.state.active)) {
                    ...
                    var P = t.props.saveHashHistory,
                      C = void 0 !== P && P;
                    t.props.hashSpy && l.default.changeHash(a, C),
                      t.props.spy &&
                        (t.setState({ active: !0 }),
